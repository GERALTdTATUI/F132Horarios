...
//Essa é a fonte da informação de última atualização dos dados, caso haja necessidade de alterar, basta colocar o link/endereço da fonte nessa variável, seguindo o formato chave: valor (chave é o nome da fonte, valor é o link/endereço da fonte)
